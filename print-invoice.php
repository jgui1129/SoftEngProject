...
<?php
	...
	echo '
                 ...
                 <b>Address of Event: </b> <span class="clientDetails">'.$row["LOCATION"].'</span><br/>
                 <b>Time & Date: </b> <span class="clientDetails">'.$row["EDATE"].' | Timein: '.$row["STARTTIME"].' |Timeout: '.$row["ENDTIME"].'</span><br/><br/>';
